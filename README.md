...
Download the release `.bin` from [GitHub Releases](https://github.com/jasonmarquette/ESP32-Plane-Radar/releases).
...
When it finishes, unplug, wait a few seconds, then plug it back in without holding **BOOT**.
